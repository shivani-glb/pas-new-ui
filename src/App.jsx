...
import { fetchAds, buildAuditPrompt, buildCampaignPrompt, fetchGemini } from './services/api';
...
const App = () => {
    ...
    useEffect(() => {
        ...
        activePlatform, activeCategory, searchQuery, searchIn, 
        filters.selCategories, filters.selCountries, filters.sortBy
    ...
    // ── Render ─────────────────────────────────────────────────────────────
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col font-sans selection:bg-indigo-500/20">
            <Header 
